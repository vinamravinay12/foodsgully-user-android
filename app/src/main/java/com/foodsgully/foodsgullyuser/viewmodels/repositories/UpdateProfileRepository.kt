...
class UpdateProfileRepository<T>(private val updateProfileData: UpdateProfileData, private val context : Context?)  : Repository(context) {
    ...
    override fun getResponse(): MutableLiveData<GenericResponse> {
        ...
        getAPIInterface()?.updateProfile(updateProfileData)
