...
class UpdatePaymentStatusRepository<T>(private val updatePaymentStatus: UpdatePaymentStatus, private val context : Context?)  : Repository(context) {
    ...
    override fun getResponse(): MutableLiveData<GenericResponse> {
        ...
        getAPIInterface()?.updateOrder(updatePaymentStatus)
